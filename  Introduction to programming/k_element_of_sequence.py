...
Input/Output
[input] integer n The number to build the sequence by.
Constraints: 2 ≤ n ≤ 30.
[input] integer k The 1-based index of the number in the sequence.
Constraints: 1 ≤ k ≤ 100.
[output] integer The kth element of the sequence.
"""
...
def kth_term(n, k):
    ...
    while len(sequence) <= k:
        power = n ** p
        new_elements = [power + x for x in sequence]
...
print(kth_term(3, 4)) #9
print(kth_term(3, 7)) #13
print(kth_term(2, 1)) #1